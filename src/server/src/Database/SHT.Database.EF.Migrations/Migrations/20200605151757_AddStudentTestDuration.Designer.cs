...
namespace SHT.Database.EF.Migrations.Migrations
{
    ...
    [Migration("20200605151757_AddStudentTestDuration")]
    partial class AddStudentTestDuration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SHT.Domain.Models.Questions.QuestionTemplateImage", b =>
                {
                    ...
                    b.HasKey("FileId", "QuestionTemplateId");

                    b.HasIndex("QuestionTemplateId");

                    b.ToTable("QuestionTemplateImage","sht");
                });

            modelBuilder.Entity("SHT.Domain.Models.Questions.QuestionTemplateTag", b =>
                {
                    ...
                    b.HasKey("TagId", "QuestionTemplateId");

                    b.HasIndex("QuestionTemplateId");

                    b.ToTable("QuestionTemplate_Tag","sht");
                });
            ...
            modelBuilder.Entity("SHT.Domain.Models.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SHT.Domain.Models.TestSessions.Assessments.Assessment", b =>
                {
                    ...
                    b.Property<bool>("VerifyImmediately")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("SHT.Domain.Models.TestSessions.Students.StudentTestSession", b =>
                {
                    ...
                    b.Property<DateTime?>("ShouldEndAt")
                        .HasColumnType("timestamp without time zone");
            ...
            modelBuilder.Entity("SHT.Domain.Models.TestSessions.TestSession", b =>
                {
                    ...
                    b.Property<TimeSpan?>("StudentTestDuration")
            ...
            modelBuilder.Entity("SHT.Domain.Models.TestSessions.Variants.Questions.TestSessionVariantQuestionImage", b =>
                {
                    b.Property<Guid>("FileId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("FileId", "TestSessionVariantQuestionId");

                    b.HasIndex("TestSessionVariantQuestionId");

                    b.ToTable("TestSessionVariantQuestionImage","sht");
                });
            ...
            modelBuilder.Entity("SHT.Domain.Models.Questions.QuestionTemplateImage", b =>
                {
                    b.HasOne("SHT.Domain.Models.Files.File", "File")
                        .WithMany()
            ...
            modelBuilder.Entity("SHT.Domain.Models.Questions.QuestionTemplateTag", b =>
                {
                    ...
                    b.HasOne("SHT.Domain.Models.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SHT.Domain.Models.TestSessions.Assessments.AnswersRatingItem", b =>
                {
                    ...
                    b.HasOne("SHT.Domain.Models.TestSessions.Students.Answers.StudentQuestionAnswer", "Answer")
                        .WithMany()
            ...
            modelBuilder.Entity("SHT.Domain.Models.Users.Account", b =>
                {
                    b.HasOne("SHT.Domain.Models.Organization", "Organization")
                        .WithMany()
